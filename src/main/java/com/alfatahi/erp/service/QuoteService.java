...
public class QuoteService {
    ...
    public void approveQuote(UUID quoteId) {
        ...
        int numParcelas = quote.getInstallments() != null ? quote.getInstallments() : 1;
        BigDecimal valorParcela = quote.getTotalValue()
        ...
        for (int i = 0; i < numParcelas; i++) {
            ...
            parcela.setDueDate(LocalDate.now().plusMonths(i + 1)); // ou calcular pelo método de pagamento
